    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==start & algosDropdown.getSelectedItem() != "Select Algorithm" & !needReset) {
            if (selectedAlgo.equals("Bubble")) {
                ...
                try {
                  noComparisons= bubble.executeBubbleSort(array, draw, this);
                ...
                try {
                    noComparisons=selection.executeSelectionSort(array, draw, this);
                    comparisonsLabel.setText("No. Comparisons: " + noComparisons);
                } catch (InterruptedException interruptedException) {
                    interruptedException.printStackTrace();
                }
                ...
                try {
                    noComparisons=insertion.executeInsertionSort(array, draw, this);
                    comparisonsLabel.setText("No. Comparisons: " + noComparisons);
                } catch (InterruptedException interruptedException) {
                    interruptedException.printStackTrace();
                }
